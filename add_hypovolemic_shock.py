...
- ✅ מוניטור (לחץ דם, דופק, סטורציה)
- ✅ חמצן בזרימה גבוהה
- ✅ דגימות: CBC, כימיה, גזים, לקטט, תרבית
...
→ ניתן לתת עד **60ml/kg** בשעה ראשונה
→ עבור לשלב 5 ↓
...
### 🔎 **שלב 5: בדיקת דימום פעיל**

<div style="display: flex; justify-content: space-around; margin: 20px 0;">

#### 🩸 **יש דימום פעיל**
- **PRBC: 10ml/kg**
- שקול פלזמה ואבחנה-תרופה
- יחס 1:1:1 במצבים חמורים
- **טיפול כירורגי** במידת הצורך
- שקול **חומצה טרנקסמית (TXA)**
...
- המשך נוזלים
- **התחל אמינים:**
  - נוראפינפרין (קו ראשון)
  - אדרנלין (אם ברדיקרדיה)
- חפש גורמים נוספים
...
### ⚠️ **שלב 6: עדיין לא יציב?**
**הסלמה נוספת:**
- 🔴 שקול **אינוטרופים** (דובוטמין, מילרינון)
- 🔴 חפש **גורמים נוספים**: ספסיס, קרדיוגני, אנפילקסיס
- 🔴 שקול **העברה ל-ICU**
- 🔴 במצב קריטי: שקול **ECMO**
